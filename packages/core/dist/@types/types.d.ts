...
export type InputComponent<P extends object> = <C extends React.ComponentType | undefined = undefined>(props: P & InputComponentProps<C> & React.RefAttributes<HTMLInputElement>) => JSX.Element;
export {};
